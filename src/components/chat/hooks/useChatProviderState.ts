...
import { CLAUDE_MODELS, CODEX_MODELS, CURSOR_MODELS, GEMINI_MODELS, TOKENC_MODELS } from '../../../../shared/modelConstants';
...
export function useChatProviderState({ selectedSession }: UseChatProviderStateArgs) {
  ...
  const [tokencModel, setTokencModel] = useState<string>(() => {
    return localStorage.getItem('tokenc-model') || TOKENC_MODELS.DEFAULT;
  });
