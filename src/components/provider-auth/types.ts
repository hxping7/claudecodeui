...
export const CLI_PROVIDERS: LLMProvider[] = ['claude', 'cursor', 'codex', 'gemini', 'tokenc'];
...
export const PROVIDER_AUTH_STATUS_ENDPOINTS: Record<LLMProvider, string> = {
  ...
  tokenc: '/api/providers/tokenc/auth/status',
};
...
export const createInitialProviderAuthStatusMap = (loading = true): ProviderAuthStatusMap => ({
  ...
  tokenc: { authenticated: false, email: null, method: null, error: null, loading },
});
